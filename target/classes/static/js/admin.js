...
function showAgencyDetail(id) {
    ...
    document.getElementById('modal-content').innerHTML = `
        ...
        <div style="display:grid;gap:0.6rem;font-size:.875rem;">
            <div><span style="color:var(--text-muted)">Số Giấy phép KD:</span> <b>${a.licenseNumber || 'Chưa cập nhật'}</b></div>
            <div><span style="color:var(--text-muted)">Loại hình KD:</span> <b>${a.agencyType || '—'}</b></div>
